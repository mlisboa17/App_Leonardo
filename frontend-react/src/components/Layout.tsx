...
import { 
  ...
  LogOut, Bot, User, Bell, AlertOctagon, Zap, BarChart2, Trophy, Shield 
} from 'lucide-react'
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { to: '/comparison', icon: <Trophy className="w-5 h-5" />, label: 'Comparação' },
    { to: '/security', icon: <Shield className="w-5 h-5" />, label: 'Segurança' },
